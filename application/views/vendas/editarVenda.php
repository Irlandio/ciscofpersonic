                                    ...
                                    <div class="controls">                                  
                                     <select id="fundoF" name="fundoF">                                       
                                        ...
                                        {?>
                                            ...
                                            <?php if($result->cod_assoc == $rcodIead->cod_Ass){ echo 'selected';} ?>>
                         ...
                         <div class="span4" >
                                ...
                                <div class="control-group">
                                    ...
                                    <p class="tipo_Pag">
                                        ...
                                        <label class="btn btn-default" submit><input name="tipoPag" id="rd-time" type="radio" <?php if($result->tipo_Pag == "Eventual"){ echo 'checked';}?>  value="Eventual" class="badgebox" style="margin-top:5px;"/><span class="badge" >&check;</span> Eventual</label>
                                        <label class="btn btn-default" submit><input name="tipoPag" id="rd-time" type="radio"   <?php if($result->tipo_Pag == "Periodico"){ echo 'checked';} ?> value="Periodico" class="badgebox" style="margin-top:5px;"/><span class="badge" >&check;</span> Periodico</label>
                                        <label class="btn btn-default" submit><input name="tipoPag" id="rd-time" type="radio"  <?php if($result->tipo_Pag == "Fixo"){ echo 'checked';}?> value="Fixo" class="badgebox" style="margin-top:5px;"/><span class="badge" >&check;</span> Fixo</label>
                                        <label class="btn btn-default" submit><input name="tipoPag" id="rd-time" type="radio"  <?php if($result->tipo_Pag == "Parcelado"){ echo 'checked';}?> value="Parcelado" class="badgebox" style="margin-top:5px;"/><span class="badge" >&check;</span> Parcelado</label>
                                ...
                                <div id = "palco">
                                 <div id = "Periodico">
                                    ...
                                    <td>
                                        <input  name="numeroDoc"  id = "numeroDoc" type="text" readonly value="<?php echo $numeroDoc = !empty($lancamento) ? $num_Doc : $result->num_Doc_Banco ?>"  >
                                        <font color=red> *</font>
